...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '9fd7e8c7e3b740c289178892ada2db8e',
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://bing.img.run/rand.php', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
  RANDOM_IMAGE_REPLACE_TEXT:
    process.env.NEXT_PUBLIC_RANDOM_IMAGE_NOT_REPLACE_TEXT ||
    'unsplash.com', // 触发替换图片的 url 关键字(多个支持用英文逗号分开)，只有图片地址中包含此关键字才会替换为上方随机图片url
  ...
  FONT_URL: [
    'https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/lxgw-wenkai-webfont/1.7.0/style.min.css',
  ],
  ...
  FONT_AWESOME:
    ...
    'https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/font-awesome/6.5.2/css/all.min.css', // font-awesome 字体图标地址; 可选 /css/all.min.css ， https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/6.0.0/css/all.min.css
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '辽ICP备2024034644号', // 备案号 闽ICP备XXXXXXX
  ...
  MERMAID_CDN:
    ...
    'https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/mermaid/10.2.4/mermaid.min.js', // CDN
  // QRCodeCDN
  QR_CODE_CDN:
    process.env.NEXT_PUBLIC_QR_CODE_CDN ||
    'https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/qrcodejs/1.0.0/qrcode.min.js',
  ...
  COMMENT_ARTALK_JS:
    ...
    'https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/artalk/2.5.5/Artalk.js', // ArtalkServert js cdn
  COMMENT_ARTALK_CSS:
    process.env.NEXT_PUBLIC_COMMENT_ARTALK_CSS ||
    'https://mirrors.sustech.edu.cn/cdnjs/ajax/libs/artalk/2.5.5/Artalk.css', // ArtalkServert css cdn
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'flt6/blog_comments', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOHGFWGw', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
        process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHGFWG84CdhLE', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://comment.flt6.top/', // 请配置完整的Waline评论地址 例如 hhttps://preview-waline.tangly1024.com @see https://waline.js.org/guide/get-started.html
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'mjnhpf87gc', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
